...
const positionComponent: TComponent = {
  name          : "position name",
...
const physicsComponent: TComponent = {
  name          : "physics name",
...
const shapeComponent: TComponent = {
  name          : "shape name",
  componentType : "shape",
  state: {
    size : 10,
...
const collisionComponent: TComponent = {
  name          : "collision name",
...
const physicsProcessor: TSystem = {
  name    : "physics_processor",
  required: ["position", "physics"],
  update(entity: TEntity, components: TComponent[], processor: TSystem) {
...
const shapeDrawProcessor: TSystem = {
...
const edgeCollisionProcessor: TSystem = {
